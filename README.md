...
| LeetCode75      | Binary Tree           |      104 | Maximum depth of binary tree                                       |
| LeetCode75      | Binary Tree           |      110 | Balanced binary tree                                               |
| LeetCode75      | Binary Tree           |      572 | Subtree of another tree                                            |
| LeetCode75      | Binary Tree           |      872 | Leaf-similar trees                                                 |
| LeetCode75      | Binary Tree           |     1161 | Maximum level sum of a binary tree                                 |
| LeetCode75      | Binary Tree           |     1448 | Count good nodes in binary tree                                    |
...
| Random          | Binary Tree           |      938 | Range sum of bst                                                   |
...
| Random          | Math                  |      415 | Add strings                                                        |
| Random          | Math                  |      441 | Arranging coins                                                    |
| Random          | Math                  |      507 | Perfect number                                                     |
...
| Random          | Sorting               |      977 | Squares of a sorted array                                          |
...
| Random          | String                |        7 | Reverse integer                                                    |
...
| TopInterview150 | Array & String        |     3190 | Find minimum operations to make all elements divisible by three    |
